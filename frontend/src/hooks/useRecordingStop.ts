  ...
  const handleRecordingStop = useCallback(async (isCallApi: boolean) => {
    ...
    try {
      ...
      if (isCallApi && transcriptionComplete == true) {
        ...
        console.log('Saving complete transcript metadata to the local database', {
          transcript_count: freshTranscripts.length,
          has_meeting_name: Boolean(savedMeetingName || meetingTitle),
        ...
        try {
          ...
          console.log('   folder_path_configured:', Boolean(folderPath));
