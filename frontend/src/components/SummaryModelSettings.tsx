...
import { ModelConfig, ModelSettingsModal, redactModelConfigSecrets } from '@/components/ModelSettingsModal';
        ...
        if (data.provider === 'custom-openai') {
          try {
            ...
            if (customConfig) {
              ...
              data.customOpenAIApiKeyConfigured = Boolean(customConfig.apiKeyConfigured);
  ...
  useEffect(() => {
    const setupListener = async () => {
      ...
      const unlisten = await listen<ModelConfig>('model-config-updated', (event) => {
        console.log('Summary model configuration updated:', { provider: event.payload.provider, model: event.payload.model, apiKeyConfigured: Boolean(event.payload.apiKey) });
