...
const LANGUAGES: Language[] = [
  ...
  { code: 'auto', name: 'ตรวจจับภาษาอัตโนมัติ (คงภาษาต้นฉบับ)' },
  { code: 'auto-translate', name: 'ตรวจจับอัตโนมัติและแปลเป็นภาษาอังกฤษ' },
      ...
      <div className="space-y-2">
        ...
        {isParakeet && (
          <div className="p-2 bg-amber-50 border border-amber-200 rounded text-amber-800">
            <p className="font-medium">⚠️ Parakeet ไม่รองรับภาษาไทยอย่างเหมาะสม</p>
            <p className="mt-1 text-xs">Parakeet รุ่นนี้เน้นภาษาอังกฤษ โปรดเลือก Local Whisper multilingual สำหรับการประชุมภาษาไทย</p>
          </div>
        )}
        ...
        <div className="text-xs space-y-2 pt-2">
          ...
          {selectedLanguage === 'auto' && (
            <div className="p-2 bg-yellow-50 border border-yellow-200 rounded text-yellow-800">
              ...
              <p className="mt-1">เพื่อความแม่นยำสูงสุดสำหรับการประชุมไทย ให้เลือก ภาษาไทย (th) โดยตรง</p>
            </div>
          )}
